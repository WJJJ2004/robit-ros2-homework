...
#include "my_custom_interfaces/msg/detail/my_custom_message__rosidl_typesupport_fastrtps_c.h"
...
using _MyCustomMessage__ros_msg_type = my_custom_interfaces__msg__MyCustomMessage;
...
size_t get_serialized_size_my_custom_interfaces__msg__MyCustomMessage(
  const void * untyped_ros_message,
...
static uint32_t _MyCustomMessage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_custom_interfaces__msg__MyCustomMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_custom_interfaces
size_t max_serialized_size_my_custom_interfaces__msg__MyCustomMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_custom_interfaces__msg__MyCustomMessage;
    is_plain =
      (
...
static size_t _MyCustomMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_custom_interfaces__msg__MyCustomMessage(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_custom_interfaces, msg, MyCustomMessage)() {
