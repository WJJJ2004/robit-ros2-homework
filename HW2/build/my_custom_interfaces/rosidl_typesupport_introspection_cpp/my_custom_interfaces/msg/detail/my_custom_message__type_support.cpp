...
{
  new (message_memory) my_custom_interfaces::msg::MyCustomMessage(_init);
}

void MyCustomMessage_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_custom_interfaces::msg::MyCustomMessage *>(message_memory);
  typed_message->~MyCustomMessage();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember MyCustomMessage_message_member_array[1] = {
  {
    "data",  // name
    ...
    offsetof(my_custom_interfaces::msg::MyCustomMessage, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MyCustomMessage_message_members = {
  ...
  1,  // number of fields
  sizeof(my_custom_interfaces::msg::MyCustomMessage),
...
{
  return &::my_custom_interfaces::msg::rosidl_typesupport_introspection_cpp::MyCustomMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_custom_interfaces, msg, MyCustomMessage)() {
  return &::my_custom_interfaces::msg::rosidl_typesupport_introspection_cpp::MyCustomMessage_message_type_support_handle;
}
